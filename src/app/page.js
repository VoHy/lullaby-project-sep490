    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between">
          <div className="text-gray-600 text-sm">© {new Date().getFullYear()} Lullaby. All rights reserved.</div>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link href="/about" className="text-gray-500 hover:text-blue-600 text-sm">Về chúng tôi</Link>
            <Link href="/contact" className="text-gray-500 hover:text-blue-600 text-sm">Liên hệ</Link>
            <Link href="/policy" className="text-gray-500 hover:text-blue-600 text-sm">Chính sách</Link>
          </div>
        </div>
      </motion.footer>
    </motion.div>
