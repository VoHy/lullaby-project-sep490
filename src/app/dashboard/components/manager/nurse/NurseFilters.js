      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-10 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-gray-50 focus:bg-white"
            />
        ...
        <div className="flex items-end">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 w-full">
            ...
            <p className="text-xs text-gray-500 mt-1">y tá được tìm thấy</p>
          </div>
        </div>
      </div>
    </div>
