  ...
  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[80vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-gray-100 px-8 py-6">
          <div className="flex justify-between items-center">
            <h3 className="text-2xl font-bold text-gray-900">Thêm Chuyên gia tư vấn mới</h3>
            <button
              onClick={onClose}
            ...
            <div className="flex justify-end gap-3">
              ...
              >
                {loading ? (
                  ...
                  <span className="inline-flex items-center gap-2"><FaPlus /> Thêm chuyên gia tư vấn</span>
                )}
              </button>
            </div>
          </div>
