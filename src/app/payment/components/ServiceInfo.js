...
//         </div>
//         <div className="font-bold text-xl text-pink-700 mb-2">
//           {service.serviceName || service.name || 'Tên dịch vụ'}
//         </div>
//         <div className="text-2xl font-bold text-pink-600">
//           {(service.price || service.Price || 0).toLocaleString()}đ
//         </div>
...
//                 {packageDetail.name || packageDetail.ServiceName || 'Gói dịch vụ'}
//               </div>
...
//                         {s.name || s.ServiceName || 'Dịch vụ con'}
//                       </span>
...
//                         <FaUserMd />
//                         <span>{getStaffInfo(s.serviceID || s.serviceTypeID).serviceName} ({getStaffInfo(s.serviceID || s.serviceTypeID).type === 'nurse' ? 'Y tá' : 'Chuyên gia'})</span>
//                       </div>
//                     )}
//                   </div>
//                 ))}
