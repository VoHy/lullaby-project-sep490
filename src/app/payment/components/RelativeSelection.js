...
//           </div>
//           <h2 className="text-2xl font-bold text-gray-800">Chọn con cho từng dịch vụ</h2>
//           <button
//             type="button"
//             className="bg-purple-600 text-white border-purple-600 border px-4 py-2 rounded transition-colors hover:bg-purple-700"
//             onClick={() => setIsOpen((v) => !v)}
//           >
//             {isOpen ? 'Đóng' : 'Chọn con'}
//           </button>
//         </div>
//         {isOpen && (
//           <div className="text-center py-8">
//             <div className="text-gray-500 text-lg mb-2">Không có dịch vụ nào cần chọn con</div>
//             <div className="text-gray-400 text-sm">Tất cả dịch vụ đã được chọn con hoặc không cần gán.</div>
//           </div>
//         )}
//       </div>
//     );
